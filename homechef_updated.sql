...
INSERT INTO `customer` (`UserID`, `OverallCustomerRating`, `numberOfRatings`)
VALUES (1, 10, 2),
       (2, 5, 5),
       (3, 5, 10),
       (6, 5, 1),
...
INSERT INTO `food` (`FoodID`, `PUserID`, `FoodName`, `pricePerUnit`, `Availability`, `Description`, `Instructions`,
                    `Img_url`)
VALUES (10000, 1, ''Fluffy Caramel Pancake'', 10, 1,
        ''Try out this simple yet delicious pancake recipe! It\''s quick and perfect for a breakfast.'',
       ...
       (10001, 1, ''Homemade Pumpkin Soup'', NULL, 0,
        ''Creamy and hearty homemade pumpkin soup that brings back all the good memories. '',
        ''Cras sit amet nibh libero, in gravida nulla.Nulla vel metus scelerisque ante sollicitudin.Cras purus odio,
        vestibulum in vulputate at,
        tempus viverra turpis. Fusce condimentum nunc ac nisi vulputate fringilla. Donec lacinia congue felis in faucibus.'',
        ''https://images.pexels.com/photos/539451/pexels-photo-539451.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=750&w=1260''),
       (10002, 2, ''Roasted Garlic Porkchop'', NULL, 0,
        ''Garlic and porkchop is the combination that many people overlook. It\''s so addicting that I can guarantee you will make this at least once a week!'',
        ''Cras sit amet nibh libero, in gravida nulla.Nulla vel metus scelerisque ante sollicitudin.Cras purus odio,
        vestibulum in vulputate at,
        tempus viverra turpis. Fusce condimentum nunc ac nisi vulputate fringilla. Donec lacinia congue felis in faucibus.'',
       ...
       (10003, 5, ''Simple Pizza'', 7, 1,
        ''Who doesn\''t crave for pizzas on a Friday movie night? If you want a cheap and simple pizza recipe,
        this is the one.'', ''Cras sit amet nibh libero, in gravida nulla.Nulla vel metus scelerisque ante sollicitudin.
        Cras purus odio, vestibulum in vulputate at,
        tempus viverra turpis. Fusce condimentum nunc ac nisi vulputate fringilla. Donec lacinia congue felis in faucibus.'',
        ''https://images.pexels.com/photos/4193872/pexels-photo-4193872.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=750&w=1260''),
       (10004, 5, ''Chocolate Mousse Cake'', 12, 1, ''This sweet,
        melts in your mouth chocolate mousse cake recipe is not only easy to make,
        but it also looks and tastes great. '', ''Cras sit amet nibh libero, in gravida nulla.Nulla vel metus
        scelerisque ante sollicitudin.Cras purus odio, vestibulum in vulputate at,
        tempus viverra turpis. Fusce condimentum nunc ac nisi vulputate fringilla. Donec lacinia congue felis in faucibus.'',
        ''https://images.pexels.com/photos/960540/pexels-photo-960540.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=750&w=1260''),
       (10005, 28, ''Homemade Pretzels'', 5, 1, ''Homemade, baked, soft pretzels perfect for a snack.'',
        ''Cras sit amet nibh libero, in gravida nulla.Nulla vel metus scelerisque ante sollicitudin.Cras purus odio,
        vestibulum in vulputate at,
        tempus viverra turpis. Fusce condimentum nunc ac nisi vulputate fringilla. Donec lacinia congue felis in faucibus.'',
        ''https://images.pexels.com/photos/4050068/pexels-photo-4050068.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940''),
       (10006, 13, ''Pork Dumplings'', 1, 1, ''Pork dumplings from your local Chinese family. Sells per dumpling. '',
        ''Cras sit amet nibh libero, in gravida nulla.Nulla vel metus scelerisque ante sollicitudin.Cras purus odio,
        vestibulum in vulputate at,
        tempus viverra turpis. Fusce condimentum nunc ac nisi vulputate fringilla. Donec lacinia congue felis in faucibus.'',
        ''https://images.pexels.com/photos/4084935/pexels-photo-4084935.jpeg?auto=compress&cs=tinysrgb&dpr=3&h=750&w=1260''),
       (10007, 4, ''Spaghetti in Meat Sauce'', 13, 1, ''Easy to make spaghetti sauce.'', ''Cras sit amet nibh libero, in
        gravida nulla.Nulla vel metus scelerisque ante sollicitudin.Cras purus odio, vestibulum in vulputate at,
        tempus viverra turpis. Fusce condimentum nunc ac nisi vulputate fringilla. Donec lacinia congue felis in faucibus.'',
        ''https://images.pexels.com/photos/128408/pexels-photo-128408.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940''),
       (10008, 14, ''Banana Bread'', NULL, 0, ''With only 3 ripe bananas, you too can bake this amazing banana bread.'',
        ''Cras sit amet nibh libero, in gravida nulla.Nulla vel metus scelerisque ante sollicitudin.Cras purus odio,
        vestibulum in vulputate at,
        tempus viverra turpis. Fusce condimentum nunc ac nisi vulputate fringilla. Donec lacinia congue felis in faucibus.'',
        ''https://images.pexels.com/photos/830894/pexels-photo-830894.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940'');
...
INSERT INTO `orderinfo` (`OrderID`, `totalPrice`, `paymentMethod`, `pickUpTime`, `contactInfo`, `Region`, `orderTime`,
                         `customerID`, `sellerID`, `Processed`)
VALUES (100001, 29.99, ''Credit card'', ''2021-03-15 21:59:54'', ''email or phone'', ''Vancouver'', ''2021-03-14 21:59:54'', 1, 2, 0),
...
INSERT INTO `orderplacement` (`OrderID`, `CustomerID`, `SellerID`)
VALUES (100001, 1, 2),
       (100002, 1, 2),
       (100004, 3, 5),
       (100007, 3, 28),
...
INSERT INTO `profile` (`UserID`, `email`, `Password`, `UserName`, `Phone`, `Location`, `Region`, `FirstName`,
                       `LastName`, `Img_url`)
VALUES (1, ''mikerr@gmail.com'', ''platinumstar'', ''mikey123'', ''778908273'', ''515 W Hastings'', ''Vancouver'', ''Mike'', ''Hawk'', ''http://www.kevmill.com/wp-content/uploads/2019/09/cropped-Kevin-profile-pic-2019-square-small-300x300.jpg''),
...
INSERT INTO `regionpickup` (`Region`, `PickupAddress`)
VALUES (''Burnaby'', ''Metrotown Station''),
...
INSERT INTO `review` (`ReviewID`, `CustomerUserID`, `FoodID`, `Rating`, `Comment`)
VALUES (20001, 1, 10000, 10, ''it was very good''),
       (20002, 14, 10003, 8, ''pretty decent''),
       (20003, 3, 10004, 10, ''yum!''),
       (20004, 7, 10001, 7, ''nice''),
       (20005, 6, 10002, 8, ''pretty good''),
       (20012, 1, 10001, 10, ''A hearty soup!'');
...
INSERT INTO `userallergies` (`UserID`, `Allergies`)
VALUES (1, ''Crayfish''),
       (1, ''Peanuts''),
       (2, ''Milk''),
       (2, ''Pineapple''),
...
DROP VIEW IF EXISTS `foodandrating`;
CREATE ALGORITHM = UNDEFINED DEFINER =`root`@`localhost` SQL SECURITY DEFINER VIEW `foodandrating` AS
select `food`.`FoodID`                    AS `FoodID`,
       `food`.`PUserID`                   AS `PUserID`,
       `food`.`FoodName`                  AS `FoodName`,
       `food`.`pricePerUnit`              AS `pricePerUnit`,
       `food`.`Availability`              AS `Availability`,
       `food`.`Description`               AS `Description`,
       `food`.`Instructions`              AS `Instructions`,
       `food`.`Img_url`                   AS `Img_url`,
       `foodreviewaverage`.`RfoodID`      AS `RfoodID`,
       `foodreviewaverage`.`avergeReview` AS `avergeReview`
from (`food`
         left join `foodreviewaverage` on ((`foodreviewaverage`.`RfoodID` = `food`.`FoodID`)));
...
DROP VIEW IF EXISTS `foodreviewaverage`;
CREATE ALGORITHM = UNDEFINED DEFINER =`root`@`localhost` SQL SECURITY DEFINER VIEW `foodreviewaverage` AS
select `review`.`FoodID` AS `RfoodID`, round(avg(`review`.`Rating`), 1) AS `avergeReview`
from `review`
group by `review`.`FoodID`;
...
DROP VIEW IF EXISTS `fullorderinfoforseller`;
CREATE ALGORITHM = UNDEFINED DEFINER =`pls`@`localhost` SQL SECURITY DEFINER VIEW `fullorderinfoforseller` AS
select `orderinfo`.`OrderID`           AS `OrderID`,
       `orderinfo`.`totalPrice`        AS `totalPrice`,
       `orderinfo`.`paymentMethod`     AS `paymentMethod`,
       `orderinfo`.`pickUpTime`        AS `pickUpTime`,
       `orderinfo`.`contactInfo`       AS `contactInfo`,
       `orderinfo`.`Region`            AS `Region`,
       `orderinfo`.`orderTime`         AS `orderTime`,
       `orderinfo`.`customerID`        AS `customerID`,
       `orderinfo`.`sellerID`          AS `sellerID`,
       `orderfoods`.`FoodID`           AS `FoodID`,
       `orderfoods`.`quantity`         AS `quantity`,
       `food`.`FoodName`               AS `FoodName`,
       `publicprofileinfo`.`FirstName` AS `FirstName`,
       `publicprofileinfo`.`LastName`  AS `LastName`,
       `regionpickup`.`PickupAddress`  AS `PickupAddress`
from ((((`orderinfo` join `orderfoods` on ((`orderinfo`.`OrderID` = `orderfoods`.`OrderID`))) join `food` on ((`orderfoods`.`FoodID` = `food`.`FoodID`))) join `publicprofileinfo` on ((`orderinfo`.`customerID` = `publicprofileinfo`.`UserID`)))
         join `regionpickup` on ((`orderinfo`.`Region` = `regionpickup`.`Region`)));
...
DROP VIEW IF EXISTS `history`;
CREATE ALGORITHM = UNDEFINED DEFINER =`root`@`localhost` SQL SECURITY DEFINER VIEW `history` AS
select `c`.`UserID`     AS `UserID`,
       `op`.`OrderID`   AS `OrderID`,
       `s`.`UserName`   AS `UserName`,
       `i`.`totalPrice` AS `totalPrice`,
       `i`.`orderTime`  AS `orderTime`,
       `i`.`pickUpTime` AS `pickUpTime`
from (((`orderplacement` `op` join `profile` `c`) join `profile` `s`)
         join `orderinfo` `i`)
where ((`c`.`UserID` = `op`.`CustomerID`) and (`s`.`UserID` = `op`.`SellerID`) and (`i`.`OrderID` = `op`.`OrderID`));
...
DROP VIEW IF EXISTS `phistory`;
CREATE ALGORITHM = UNDEFINED DEFINER =`pls`@`localhost` SQL SECURITY DEFINER VIEW `phistory` AS
select `c`.`UserID`     AS `UserID`,
...
DROP VIEW IF EXISTS `publicprofileinfo`;
CREATE ALGORITHM = UNDEFINED DEFINER =`root`@`localhost` SQL SECURITY DEFINER VIEW `publicprofileinfo` AS
select `profile`.`UserID`    AS `UserID`,
       `profile`.`UserName`  AS `UserName`,
       `profile`.`Region`    AS `Region`,
       `profile`.`FirstName` AS `FirstName`,
       `profile`.`LastName`  AS `LastName`,
       `profile`.`Img_url`   AS `Img_url`
from `profile`;
